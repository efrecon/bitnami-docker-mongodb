...
export MONGODB_USERNAMES="${MONGODB_USERNAMES:-}"
export MONGODB_PASSWORDS="${MONGODB_PASSWORDS:-}"
export MONGODB_DATABASES="${MONGODB_DATABASES:-}"
export ALLOW_EMPTY_PASSWORDS="${ALLOW_EMPTY_PASSWORDS:-no}"
