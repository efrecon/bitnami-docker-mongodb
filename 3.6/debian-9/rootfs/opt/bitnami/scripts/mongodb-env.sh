...
# User and database creation settings. Uses the deprecated variables without the
# trailing S whenever these exist.
export MONGODB_ROOT_PASSWORD="${MONGODB_ROOT_PASSWORD:-}"
export MONGODB_USERNAME="${MONGODB_USERNAME:-}"
export MONGODB_PASSWORD="${MONGODB_PASSWORD:-}"
export MONGODB_DATABASE="${MONGODB_DATABASE:-}"
export MONGODB_USERNAMES="${MONGODB_USERNAMES:-${MONGODB_USERNAME:-}}"
export MONGODB_PASSWORDS="${MONGODB_PASSWORDS:-${MONGODB_PASSWORD:-}}"
export MONGODB_DATABASES="${MONGODB_DATABASES:-${MONGODB_DATABASE:-}}"
